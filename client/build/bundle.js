...
/***/ function(module, exports, __webpack_require__) {
	...
	var NflBox = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(NflBox, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NflBox = React.createClass({
	  ...
	  setDate: function setDate(date) {
	    ...
	    try {
	      for (var _iterator = splitDate[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  buildURL: function buildURL(gameNumber) {
	  ...
	  ajaxRunner: function ajaxRunner() {
	    var _this = this;
	    ...
	    while (validGames < 16) {
	      ...
	      gameNumber++;
	      this.apiCall(url).then(function (result) {
	        var gameData = JSON.parse(result.responseText);
	        console.log(gameData);
	        var newGame = _this.state.games.concat([gameData]);
	        _this.setState({ games: newGame });
	      }, function (error) {
	        console.log(error);
	      });
	      validGames++;
